      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="space-y-1 text-left">
          ...
          <div className="relative">
            ...
            <input type="email" placeholder="abc@gmail.com" value={email} onChange={(e) => setEmail(e.target.value)} required className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-4 text-sm text-slate-855 placeholder-slate-400 outline-hidden focus:bg-white focus:border-secondary focus:ring-1 focus:ring-secondary/45 transition duration-200" />
          </div>
        </div>
        <div className="space-y-1 text-left">
          ...
          <div className="relative">
            ...
            <input type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-4 text-sm text-slate-855 placeholder-slate-400 outline-hidden focus:bg-white focus:border-secondary focus:ring-1 focus:ring-secondary/45 transition duration-200" />
          </div>
        </div>
        <button type="submit" className="w-full bg-secondary hover:bg-emerald-600 text-white font-bold py-3 rounded-xl transition duration-200 shadow-md hover:shadow-secondary/10 hover:-translate-y-0.5 mt-2 cursor-pointer">Register</button>
      </form>
